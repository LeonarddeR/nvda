...
* Sentence navigation (`alt+upArrow` and `alt+downArrow`) now works in browse mode and other documents, using the Windows built-in ICU library for Unicode-aware sentence boundary detection. Previously it was only supported in Microsoft Word and Outlook. (#20343, @LeonarddeR)
