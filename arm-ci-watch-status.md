...
*
* Result: <https://github.com/LeonarddeR/nvda/actions/runs/30566465513>
...
* Per-suit<https://github.com/LeonarddeR/nvda/actions/runs/30566465513>_annotations FAIL, chrome_language FAIL, chrome_link FAIL, chrome_list FAIL, chrome_misc FAIL, chrome_misc_aria FAIL, chrome_roleDescription FAIL, chrome_table FAIL
...
<<https://github.com/LeonarddeR/nvda/actions/runs/30517046822>>>
*<https://g><https://github.com/LeonarddeR/nvda/actions/runs/30566465513>g)
...
*<https://g>pdate: no origin/master change; merged leonard/try-testOnArm (prek auto-fix), kept full log
...
*<https://g><https://github.com/LeonarddeR/nvda/actions/runs/30084982840>
*
...
* NOTE: ru<https://github.com/LeonarddeR/nvda/actions/runs/29953208083>lished 2026-07-27) had NOT rolled out to the hosted win11-arm64 pool at run time. Effectively a re-test on the previous image.

* Per-suite arm results: startupShutdown FAIL, installer FAIL, chrome_annotations FAIL, chrome_language FAIL, chrome_link FAIL, chrome_list FAIL, chrome_misc FAIL, chrome_misc_aria FAIL, chrome_roleDescription FAIL, chrome_table FAIL
*
* Assessme<https://github.com/LeonarddeR/nvda/actions/runs/30084982840>heft signature: "Timed out waiting Welcome to NVDA to focus" / "Specific speech did not occur before timeout: Welcome to NVDA"
*
...
* NOTE: ru<https://github.com/LeonarddeR/nvda/actions/runs/29764022234>4 (published 2026-07-19) still not rolled out to the hosted win11-arm64 pool as of 2026-07-22.
